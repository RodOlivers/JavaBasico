...
public class Principal {
		...
		public static void main(String[] args) {
			...
			if (login(sc, dao) == 1) {
				...
				//crie a opção 1 para buscar todos os usuarios
				//crie a opção 2 para Cadastrar
				//crie a opção 3 para Editar
				//crie a opção 4 para Deletar
...
//		System.out.println(u.getNmeUsuario());
		...
		/**
		 * Crie um método login: Retorna true (Caso usuario e senha esteja correto) e false 
		 * (Quando usuario e senha estiver errado) Informe "Login Realizado com Sucesso!" caso true ou 
		 * Seu usuario e senha estão incorretos, informe novamente. (Crie um loop com a opção para sair)
		 */
	}
